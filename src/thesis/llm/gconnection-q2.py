...
# Pacing: lancia una richiesta ogni N secondi
LAUNCH_INTERVAL_SEC = 65
# Max richieste contemporanee in flight
MAX_INFLIGHT = 5

MODEL_ID = "gemma-4-26b-a4b-it"
SAFE_MODEL_NAME = MODEL_ID.replace(":", "_")
OUT_FILENAME = f"output_q_gemini_{SAFE_MODEL_NAME}_q2.csv"
...
def build_history_prompt(base_prompt: str, base: str, sample: list[StateEntry]) -> str:
    ...
    for h in sample:
        ...
        # Nidifichiamo l'azione all'interno della history (logica q2)
        parts.append(
...
def run():
    load_api_keys()
    client = GeminiLLM(model_id=MODEL_ID, temperature=0.5)
    ...
    # Leggiamo il metadata.csv e prendiamo SOLO le entry_type=1 (logica q2)
